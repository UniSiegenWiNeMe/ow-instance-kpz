...
import de.openinc.ow.core.data.model.valuetypes.OpenWareString;
...
public class ZugStringHandler implements DataHandler{

	private String idprefix;
	private DataHandler handler;
	private String user;
	private OpenWareDataItem item;
	public ZugStringHandler(String id, String user){
		this.idprefix = id;
		this.user = user;
	...
	public List<OpenWareDataItem> handleData(String id, String data) {
		...
		try{
				...
				val.addValueDimension(new OpenWareString(data));
				vals.add(val);
				item.value(vals);
